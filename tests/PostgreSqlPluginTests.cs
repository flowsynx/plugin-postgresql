...
public class PostgreSqlPluginTests
{
    ...
    public PostgreSqlPluginTests()
    {
        ...
        _plugin = new PostgreSqlPlugin(_reflectionGuardMock.Object);
    }
    ...
    [Fact]
    public void GetSqlAndParameters_ReturnsSqlAndParams()
    {
        var input = new InputParameter { Sql = "SELECT 1", Params = new Dictionary<string, object> { { "id", 1 } } };
        var result = typeof(PostgreSqlPlugin)
            .GetMethod("GetSqlAndParameters", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
            .Invoke(_plugin, new object[] { input });
        Assert.NotNull(result);
    }

    [Fact]
    public void NormalizePostgresConnectionString_ParsesUri()
    {
        var uri = "postgres://user:pass@localhost:5432/dbname";
        var result = typeof(PostgreSqlPlugin)
            .GetMethod("NormalizePostgresConnectionString", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
